...
**Completed:**
- Homepage prototype (HTML/CSS) -- people-first design, green/gold palette
...
- Design direction: people not buildings
...
- Real Google reviews used as homepage testimonial content
...
**Next:** Team reviews design paper -> Phase 2 copywriting -> Phase 3 build
