...
|---|---|---|---|
| Lance Adams | [email redacted] | [password redacted] | admin |
| Dave Swete | [email redacted] | [password redacted] | admin |
...
### P2 — Login security
- [ ] Add password hashing (currently plaintext [password redacted])
